...
// ======================= BUILDERS (REUSABLE) ======================
PatternScore _BuildSingle(const CandleData &c1, double atr) // [FIX] removed static
{
...
PatternScore _BuildDouble(const CandleData &c1, const CandleData &c2, double atr) // [FIX] removed static
{
...
PatternScore _BuildTriple(const string sym, ENUM_TIMEFRAMES tf, int shift_base, double atr, const CandleData &c1) // [FIX]
{
...
PatternScore _BuildFive(const string sym, ENUM_TIMEFRAMES tf, int shift_base, double atr, const CandleData &c1) // [FIX]
{
